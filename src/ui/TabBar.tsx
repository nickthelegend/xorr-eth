 ...
 * and shrinks away when you leave (2026-09-17). It used to appear and vanish between two frames, which on the one
 * control that answers navigation read as a redraw rather than an answer. One property, `transform: scale`, over the
 * 150ms the segmented thumb takes, because selection must feel instant. The glyph's own colour still snaps: it is the
 * state, and it must be right in the frame the tap lands, including under reduced motion where nothing grows.
 *
...
const BAR_H = 60;
const ITEM_H = 50;
/** Where the mark under Home starts: nothing. It grows out from behind the glyph and shrinks back into it. */
const MARK_FROM = 0;
const GLYPH = 26;
const STROKE = 2.1;
const BADGE_H = 17;
