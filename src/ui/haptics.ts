 ...
 *
 * A tick when a selection changes: a switch flips, a segment or a filter is chosen. That is the whole of it in the design
 * system. A fill, a refusal and the stop each get their own when the screens that own those moments call them, and
 * nothing else in the app buzzes — a phone that vibrates on every tap stops meaning anything by the second screen.
 *
...
/** The one heavy moment: pulling the stop. */
