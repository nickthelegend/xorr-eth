...
describe('13.6 motion audit — animations.md', () => {
  ...
  /*
   * TWO animated views, and the rule they both keep is that neither moves while you read the screen: the bar
   * answers the Messages drawer, and the mark under Home answers navigation. Nothing on the bar is ambient.
   * A third would need the same argument, which is why the count is pinned rather than the properties alone.
   */
