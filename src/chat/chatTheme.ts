 ...
 *
 * ## Following the phone (2026-09-17)
 *
 * It used to be black unless someone had chosen light, on the reading that everything outside the drawer is true black
 * and a light room rising over it is the one bright surface in the app. That reading is still right about the *app*;
 * it was wrong about the *person*. Someone whose phone is in light mode has already said which room they want to read
 ...
 * so a drawer left open follows it, and `ChatSheet`'s cross-fade makes that a dissolve rather than a flash.
 */
