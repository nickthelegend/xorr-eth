 ...
 *
 * So the room that is LEAVING stays for a moment, painted over the one that has arrived, and fades out. What dissolves
 * is its ground: the new room is already fully drawn underneath, so the fade reveals rather than assembles. Nothing is
 * mid-way at any point — both rooms are complete, and one of them is simply becoming transparent.
 *
 * 250ms, the interaction scale, because the change answers a tap. It is the same 250 whether the phone changed its own
 * appearance or a finger did, since a dissolve slower than that reads as the app catching up.
 *
